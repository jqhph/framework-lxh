...
<div class="form-group clearfix">
    ...
    <div class="col-md-<?php echo $formCol;?>">
        <input <?php if ($disabled) echo 'disabled';?> value="<?php echo $value ? date('Y-m-d H:i:s', $value) : '';?>" type="text" placeholder="<?php echo empty($placeholder) ? '' : trans($placeholder);?>" name="<?php echo $name;?>" class="form-control" >
