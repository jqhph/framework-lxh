...
use Parsedown;
use Lxh\Support\HtmlString;
use Lxh\Contracts\View\Factory as ViewFactory;
...
class Markdown
{
     ...
     *
     * @param  \Lxh\Contracts\View\Factory  $view
     * @param  array  $options
     * @return void
     */
    ...
    public function render($view, array $data = [], $inliner = null)
    {
        ...
        return new HtmlString($inliner->convert(
