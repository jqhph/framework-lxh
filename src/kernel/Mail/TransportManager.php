...
use Lxh\Support\Manager;
use GuzzleHttp\Client as HttpClient;
use Swift_SmtpTransport as SmtpTransport;
use Lxh\Mail\Transport\LogTransport;
use Lxh\Mail\Transport\SesTransport;
use Lxh\Mail\Transport\ArrayTransport;
use Swift_SendmailTransport as MailTransport;
use Lxh\Mail\Transport\MailgunTransport;
use Lxh\Mail\Transport\MandrillTransport;
use Lxh\Mail\Transport\SparkPostTransport;
...
class TransportManager extends Manager
{
     ...
     *
     * @return \Lxh\Mail\Transport\MailgunTransport
     */
     ...
     *
     * @return \Lxh\Mail\Transport\MandrillTransport
     */
     ...
     *
     * @return \Lxh\Mail\Transport\SparkPostTransport
     */
     ...
     *
     * @return \Lxh\Mail\Transport\LogTransport
     */
     ...
     *
     * @return \Lxh\Mail\Transport\ArrayTransport
     */
    ...
    protected function guzzle($config)
    {
        return new HttpClient(Arr::add(
            getvalue($config, 'guzzle', []), 'connect_timeout', 60
        ));
    }
