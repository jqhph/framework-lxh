...
use Closure;
use Lxh\Admin\Grid;
use Lxh\Admin\Grid\Displayers\AbstractDisplayer;
...
class Column
{
    ...
    /**
     * Mark this column as searchable.
     *
     * @return Column
     */
    ...
    public function fill(array $data)
    {
        foreach ($data as $key => &$row) {
            $this->original = $value = get_value($row, $this->name);
    ...
    {
        return isset(static::$defined[$this->name]);
    }
    ...
    {
        $this->sort = I($this->grid->model()->getSortName());
