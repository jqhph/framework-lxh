...
class InstallCommand extends Command
{
    ...
    public function publishDatabase()
    {
        ...
        $this->call('db:seed', ['--class' => \Lxh\Admin\Auth\Database\AdminTablesSeeder::class]);
    }
    ...
    protected function createMenuFile()
    {
        ...
        resolve('files')->put($file, $contents);
    ...
    protected function createRoutesFile()
    {
        ...
        resolve('files')->put($file, str_replace('DummyNamespace', Admin::controllerNamespace(), $contents));
    ...
    {
        resolve('files')->copyDirectory(__DIR__.'/../../lang/', "{$this->directory}/lang/");
    }
    ...
    {
        return resolve('files')->get(__DIR__."/stubs/$name.stub");
    }
    ...
    {
        resolve('files')->makeDirectory("{$this->directory}/$path", 0755, true, true);
    }
}
