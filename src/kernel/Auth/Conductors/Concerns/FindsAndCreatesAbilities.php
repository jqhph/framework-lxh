...
trait FindsAndCreatesAbilities
{
     ...
     * @param  \Lxh\Database\Eloquent\Model|string|array|null  $model
     ...
     * @param  \Lxh\Database\Eloquent\Model|string|array  $model
     * @param  array  $attributes
     * @return array
     */
     ...
     * @param  \Lxh\Database\Eloquent\Model|string  $entity
     * @param  array  $attributes
     ...
     * @param  \Lxh\Database\Eloquent\Model|string  $entity
     * @param  array  $attributes
     * @return \Lxh\Auth\Database\Ability|null
     */
     ...
     * @return \Lxh\Database\Eloquent\Model|string
     */
