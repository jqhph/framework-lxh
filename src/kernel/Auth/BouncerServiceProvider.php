...
use Lxh\Auth\Console\CleanCommand;

use Lxh\Cache\ArrayStore;
use Lxh\Support\ServiceProvider;
use Lxh\Contracts\Auth\Access\Gate;
...
class BouncerServiceProvider extends ServiceProvider
{
    ...
    {
        Relation::morphMap([
            \Lxh\Auth\Database\Role::class,
            \Lxh\Auth\Database\Ability::class,
        ]);
    }
     ...
     * Get the user model from the application's auth config.
     *
     * @param  \Lxh\Config\Repository  $config
     * @return string|null
     */
