...
<div class="row">
    <div class="col-lg-3 col-md-6">
        <div class="card-box widget-user">
            <div>
                <img src="<?php echo load_img('users/avatar-3.jpg')?>" class="img-responsive img-circle" alt="user">
    ...
    <div class="col-lg-3 col-md-6">
        <div class="card-box widget-user">
            <div>
                <img src="<?php echo load_img('users/avatar-2.jpg')?>" class="img-responsive img-circle" alt="user">
                <div class="wid-u-info">
    ...
    <div class="col-lg-3 col-md-6">
        <div class="card-box widget-user">
            <div>
                <img src="<?php echo load_img('users/avatar-1.jpg')?>" class="img-responsive img-circle" alt="user">
                <div class="wid-u-info">
    ...
    <div class="col-lg-3 col-md-6">
        <div class="card-box widget-user">
            <div>
                <img src="<?php echo load_img('users/avatar-10.jpg')?>" class="img-responsive img-circle" alt="user">
                <div class="wid-u-info">
            ...
            <div class="inbox-widget nicescroll" style="height: 315px;">
                <a href="#">
                    <div class="inbox-item">
                        <div class="inbox-item-img"><img src="<?php echo load_img('users/avatar-1.jpg')?>" class="img-circle" alt=""></div>
                ...
                <a href="#">
                    <div class="inbox-item">
                        <div class="inbox-item-img"><img src="<?php echo load_img('users/avatar-2.jpg')?>" class="img-circle" alt=""></div>
                ...
                <a href="#">
                    <div class="inbox-item">
                        <div class="inbox-item-img"><img src="<?php echo load_img('users/avatar-3.jpg')?>" class="img-circle" alt=""></div>
                ...
                <a href="#">
                    <div class="inbox-item">
                        <div class="inbox-item-img"><img src="<?php echo load_img('users/avatar-5.jpg')?>" class="img-circle" alt=""></div>
